...
// Add styles for select and button
const selectSize = document.getElementById('matrix-size');
selectSize.style.padding = '8px 12px';
selectSize.style.fontSize = '16px';
selectSize.style.borderRadius = '4px';
selectSize.style.border = '1px solid #ccc';
selectSize.style.backgroundColor = '#fff';
selectSize.style.cursor = 'pointer';
selectSize.style.margin = '10px 0';

const calculateBtn = document.getElementById('calculate-btn');
calculateBtn.style.padding = '10px 20px';
calculateBtn.style.fontSize = '16px';
...
calculateBtn.style.margin = '10px 0';
